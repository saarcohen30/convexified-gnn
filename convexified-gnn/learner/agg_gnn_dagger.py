...
class AggDAGGER(object):
    ...
    def select_action(self, state):
        ...
        mu = self.actor(state.delay_state, state.curr_gso)  # .to(self.device)
    ...
    def gradient_step(self, batch):
        ...
        actor_batch = self.actor(delay_state_batch, curr_gso_batch)
