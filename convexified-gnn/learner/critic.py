...
class Critic(nn.Module):
    ...
    def __init__(self, n_s, n_a, hidden_layers, k):
        """
        The critic network is centralized, thus it can have any number of layers.
        If there are a lot of layers, it doesn't matter if we have a non-linearity or GSO first.
